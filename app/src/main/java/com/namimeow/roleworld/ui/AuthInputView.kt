package com.namimeow.roleworld.ui
...
constructor(
    ...
    init {
        ...
        hintPaint.color = resources.getColor(R.color.hint_primary)
    ...
    fun setError(autoClear: Boolean = true) {
        ...
        animateIconColor(resources.getColor(R.color.text_secondary), resources.getColor(R.color.red))
    }
    ...
    override fun onTextChanged(
        ...
        if (errorAutoClear) {
            ...
            animateIconColor(resources.getColor(R.color.red), resources.getColor(R.color.text_secondary))
        }
